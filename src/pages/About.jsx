                    ...
                    <div className="tech-section">
                        <div className="left-col">
                            ...
                            <div className="languages">
                                <ul className="ul">
                                    <p> skills</p>
                                    <li>React.js</li> <li>JavaScript</li> <li>C++</li>
                                </ul>

                                <ul className="ul">
                                    <p> skills</p>
                                    <li>PHP (basic)</li> <li>Python</li>
                                </ul>
                            </div>
